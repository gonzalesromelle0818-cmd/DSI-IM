...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    ...
    >
      ...
      {reorderAlertCount > 0 && (
        <div className="p-3 mx-3 mb-3 rounded-lg bg-amber-950/40 border border-amber-500/30 text-amber-200 text-xs">
      ...
      {/* Authenticated User & Logout Action Section in Sidebar */}
      <div className="p-3 mx-2 mb-2 rounded-xl bg-slate-900/90 border border-slate-800">
        <div className="flex items-center justify-between pb-2 border-b border-slate-800/60 mb-2">
          <div className="flex items-center space-x-2 min-w-0">
            <div className="w-7 h-7 rounded-lg bg-teal-600/20 text-teal-400 flex items-center justify-center text-xs font-bold border border-teal-500/30 flex-shrink-0">
